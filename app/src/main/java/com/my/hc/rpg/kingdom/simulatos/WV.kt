...
import com.my.hc.rpg.kingdom.simulatos.Constants.CCAMP2
import com.my.hc.rpg.kingdom.simulatos.Constants.CCAMP3
...
class WV : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        view1 = findViewById(R.id.PLView)
    ...
    private fun getUrl(): String {
        ...
        val cpOne: String? = Hawk.get(CCAMP1)
        val cpTwo: String? = Hawk.get(CCAMP2)
        val cpThree: String? = Hawk.get(CCAMP3)
        ...
        val pack = "com.my.hc.rpg.kingdom.simulatos"
        ...
        val first = "https://"
        val second = "palmlodge.site/8uY7w"
